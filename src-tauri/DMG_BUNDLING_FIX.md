...
The DMG will be at `src-tauri/target/release/bundle/dmg/Chinotto_0.2.0_aarch64.dmg`. You can then sign and notarize it as usual.
...
rm -f target/release/bundle/dmg/Chinotto_0.2.0_aarch64.dmg
rm -f target/release/bundle/dmg/rw.*.Chinotto_0.2.0_aarch64.dmg
